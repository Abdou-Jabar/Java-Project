...
public class AbonneDAO {
    ...
    /**
     *  Rechercher un abonné avec unn nom et prenom
     */
    
    /*public static List<Abonne> rechercherAbonneParNom(Abonne abonne){
        Connection conn = Connexion.Connect();
    ...
    /*
        Rechecher un abonné
    */
    public static Abonne rechercherAbonne(String idAbonne){
